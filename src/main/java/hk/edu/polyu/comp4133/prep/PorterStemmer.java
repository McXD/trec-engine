...
/**
 * The Porter stemmer. Adapted from the Internet: <a href="https://github.com/caarmen/porter-stemmer/blob/master/library/src/main/java/ca/rmen/porterstemmer/PorterStemmer.java">...</a>
 */
public class PorterStemmer implements Stemmer{
    ...
    public String stem(String word) {
        ...
        // turn the last letter to uppercase
        if (stem.length() > 1) {
            stem = stem.substring(0, stem.length() - 1) + stem.substring(stem.length() - 1).toUpperCase(Locale.getDefault());
        }
